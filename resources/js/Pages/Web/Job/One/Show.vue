      ...
      <div class="row">
        <div class="col-xxl-9 col-xl-8">
          <div class="details-post-data me-xxl-5 pe-xxl-4" :class="{'opportunity-post-data': job.type && !job.type.startsWith('job_')}">
            ...
            <ul class="share-buttons d-flex style-none flex-wrap">
            ...
            <div class="post-block border-style mt-50 lg-mt-30">
              <div class="d-flex align-items-center">
                <div
                  class="block-numb fw-500 rounded-circle me-2 text-center text-white"
                >
                  1
                </div>
        ...
        <div class="col-xxl-3 col-xl-4">
          <div class="job-company-info ms-xl-5 ms-xxl-0 lg-mt-50" :class="{'opportunity-company-info': job.type && !job.type.startsWith('job_')}">
            ...
            />
            <div class="text-md text-dark mt-15 mb-20 text-center">
            ...
            <div class="border-top mt-40 pt-40">
              ...
              <div
                v-if="authUser && authUser.role != 'user'"
              ...
              <div v-else-if="authUser">
                ...
                <div v-if="job.apply_type == 2">
                  <a
                    :href="JSON.parse(job.meta).apply_type?.value"
