...
import { displayText } from '@/Utils/personaMapping'
...
const deleteAppliedJob = (id) => {
  // Use the original backend route name
...
<template>
  <Head title="Dashboard | Seeker Panel" />
  <h2 class="main-title">{{ trans('Seeker Dashboard') }}</h2>
