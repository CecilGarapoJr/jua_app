...
const shortCodesForm = computed(() => {
  return {
    ...
    job_name: form.title || 'Opportunity Title'
  }
})
...
const submit = () => {
  ...
  if (props.plan.job_limit !== -1 && props.job_count >= props.plan.job_limit) {
    notify.danger('You have reached your Opportunity post limit. Please upgrade your plan!')
    return
  }
...
const getDescriptionTemplates = () => {
  ...
  axios
    .get(route('api-description-templates', { service: form.service_id, type: 'opportunity' }))
    .then((res) => {
...
<template>
  ...
  <h2 class="main-title">{{ trans('Post a New Opportunity') }}</h2>

  <form @submit.prevent="submit" enctype="multipart/form-data" class="card-box border-20 bg-white">
    <h4 class="dash-title-three">{{ trans('Opportunity Details') }}</h4>
    <label class="mb-1" for="">{{ trans('Opportunity Title') }}*</label>
    ...
    <div class="row mb-30">
      ...
      <div class="col-md-4">
        <label class="mb-1" for="">{{ trans('Opportunity Category') }}*</label>
        <Multiselect
      ...
      <div class="col-md-4">
        <label class="mb-1" for="">{{ trans('Opportunity Type') }}*</label>
        <Multiselect
          v-model="form.type"
    ...
    <div class="d-flex justify-content-between align-items-center">
      <label class="mb-1" for="">{{ trans('Opportunity Description') }}*</label>
      <button
    ...
    <div class="dash-input-wrapper">
      ...
      <textarea
        ...
        class="size-lg"
        placeholder="Brief description for your Opportunity...."
      ></textarea>
    ...
    <div class="col-md-6 mt-30">
      <label class="mb-1" for="">{{ trans('Opportunity Deadline') }}</label>
      <div class="dash-input-wrapper mb-30">
        <input
          :min="today()"
          :max="maxExpiredDate"
