<template>
  <main class="container p-4 sm:p-6">
    ...
    <div class="space-y-6">
      <Overview :items="opportunityStats" grid="4" />
              ...
              <ul class="p-4 space-y-4 dropdown-list">
                ...
                <li class="dropdown-list-item">
                  <div class="mb-2">
                    ...
                    >
                      <option value="email">
                        {{ trans("Organisation Email") }}
                      </option>
                      <option value="name">{{ trans("Organisation Name") }}</option>
                      <option value="title">
                        {{ trans("Title") }}
                      </option>
                      <option value="status">
        ...
        <table class="table">
          <thead>
            <tr>
              ...
              <th class="">{{ trans("Organisation Name") }}</th>
  ...
  <div id="editJobDrawer" class="drawer drawer-right">
    <form @submit.prevent="updateJob()">
      ...
      <div class="drawer-body">
        <div class="mb-2">
          <label class="mb-2 label">{{ trans("Opportunity Live Days") }}</label>
          <input
...
const updateJob = () => {
  ...
  router.patch(route("admin.job.update", editForm.value.id), editForm.value, {
    onSuccess: () => {
      editForm.value = {};
      notify.success(trans("Opportunity has been updated successfully"));
