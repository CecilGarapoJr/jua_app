...
<template>
  <main class="container flex-grow p-4 sm:p-6">
    <HeaderSegment title="Edit organisation" :segments="segments" :buttons="buttons" />
    <div class="space-y-6">
      <div class="grid grid-cols-12">
        <div class="col-span-5">
          <strong>{{ trans('Edit organisation') }}</strong>
          <p>
            {{ trans('Edit your organisation details and necessary information from here') }}
          </p>
        </div>
