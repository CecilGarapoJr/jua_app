...
const organisationStats = [
  { value: props.total_companies, title: trans('Total Organisations'), iconClass: 'bx bx-list-ul' },
  { value: props.active_companies, title: trans('Active Organisations'), iconClass: 'bx bx-check-shield' },
  { value: props.inactive_companies, title: trans('Inactive Organisations'), iconClass: 'bx bx-x-circle' },
  {
    value: props.verified_companies,
    title: trans('Verified Organisations'),
...
<template>
  <main class="container flex-grow p-4 sm:p-6">
    <HeaderSegment :title="trans('Organisations')" :segments="segments" :buttons="buttons" />

    <div class="space-y-6">
      <Overview :items="organisationStats" class="lg:grid-cols-3" />
