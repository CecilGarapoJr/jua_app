...
const organisationStats = [
  { value: props.job_posted, title: trans("Opportunities Posted"), iconClass: "bx bx-box" },
  {
...
<template>
  <main class="container flex-grow p-4 sm:p-6">
    <HeaderSegment title="Organisation details" :segments="segments" :buttons="buttons" />
    <div class="space-y-6">
      <Overview :items="organisationStats" />
      ...
      <div>
        <h5 class="mb-2">{{ trans("Organisation Opportunities") }}</h5>
        <div class="table-responsive whitespace-nowrap rounded-primary">
          <table class="table">
            <thead>
              <tr>
                <th class="w-[5%] uppercase">{{ trans("Title") }}</th>
                <th class="w-[15%] uppercase">{{ trans("Opportunity Created") }}</th>
