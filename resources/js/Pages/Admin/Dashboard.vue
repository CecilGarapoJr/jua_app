...
const props = defineProps([
  'totalOrders',
  'totalSales',
  'totalJobs',  // Will be displayed as 'Opportunities'
  'totalEmployer',  // Will be displayed as 'Organisation'
  'totalCandidate',  // Will be displayed as 'Applicant'
  'totalAppliedJobs',
  'totalKYCRequest',
  'totalJobBookmarks',
  'mostViewedJob',  // Will be displayed as 'Most Viewed Opportunity'
  'mostOrderedPlan',
  'popularPlans',
  'recentOrders',
  'recentJobs',
...
const primaryOverview = computed(() => {
  return [
    ...
    {
      title: 'Total Applied Opportunities',
    ...
    {
      title: 'Total Opportunity Bookmarks',
      url: route('admin.job.index'),
  ...
  <main class="container flex-grow p-4 sm:p-6">
    ...
    <div class="space-y-6">
        ...
        <div class="order-4 col-span-1 space-y-6">
          ...
          <div class="card">
            <div class="card-body flex flex-col gap-2">
              <div class="flex flex-wrap items-center justify-between">
                <h6>{{ trans('Most Viewed Opportunity') }}</h6>
                <div class="flex items-center gap-2">
                  <template v-for="(sort, i) in mostSorts" :key="sort.label">
                    <button
                      type="button"
      ...
      <section class="grid grid-cols-1 place-items-start gap-6 lg:grid-cols-2">
        ...
        <div class="card">
          <div class="card-body">
            <h6>{{ trans('Recent Opportunities') }}</h6>
