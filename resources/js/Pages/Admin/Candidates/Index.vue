...
const applicantStats = [
  { value: props.total_candidates, title: trans('Total Applicants'), iconClass: 'bx bx-list-ul' },
  { value: props.active_candidates, title: trans('Active Applicants'), iconClass: 'bx bx-check-shield' },
  { value: props.inactive_candidates, title: trans('Inactive Applicants'), iconClass: 'bx bx-x-circle' },
  {
    value: props.verified_candidates,
    title: trans('Verified Applicants'),
...
<template>
  <main class="container flex-grow p-4 sm:p-6">
    <HeaderSegment :title="trans('Applicants')" :segments="segments" :buttons="buttons" />

    <div class="space-y-6">
      <Overview :items="applicantStats" class="lg:grid-cols-3" />
