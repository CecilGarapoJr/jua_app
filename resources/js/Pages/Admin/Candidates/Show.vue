...
const applicantStats = [
	...
	{ value: props.total_applied_jobs, title: trans('Applied Opportunities'), iconClass: 'ti ti-thumb-up' },
]
...
<template>
	<main class="container flex-grow p-4 sm:p-6">
		<HeaderSegment title="Applicant details" :segments="segments" :buttons="buttons" />
		<div class="space-y-6">


			<Overview :items="applicantStats" />
