...
export var navMenuItems = [
  ...
  },
  {
    ...
    subs: [
      ...
      {
        permission: 'job-category', // Backend permission name remains unchanged
        text: 'Categories',
        uri: route('admin.job-category.index')
      },
      {
        permission: 'job-tags', // Backend permission name remains unchanged
        text: 'Skills',
